...
import momojiComputerImage from "@/assets/images/memoji-computer.png";
  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        ></div>
        <div className="size-[620px] ring-style"></div>
        <div className="size-[820px] ring-style"></div>
        <div className="size-[1020px] ring-style"></div>
        <div className="size-[1220px] ring-style"></div>
        <HeroOrbit
          size={430}
          rotation={-14}
          shouldOrbit
      ...
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          ...
          <button className="inline-flex items-center gap-2 border border-white bg-white text-gray-900 px-6 py-1.5 h12 rounded-xl">
            <span>👋</span>
